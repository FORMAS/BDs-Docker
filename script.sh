...
# instala mysql
docker run --name NOME -e MYSQL_ROOT_PASSWORD=SENHA -d mysql/mysql-server:latest
# NOME = bdmysql
# SENHA = senha
...
# instala postgres
docker run --name NOME -e POSTGRES_PASSWORD=SENHA -d postgres
# NOME = bdpostgres
# SENHA = senha
...
docker run --name NOME -d mongo:latest
# NOME = bdmongo
